...
export const CHATS: Chat[] = [
...

  {
    ...
    goodOptionId: 1,
    goodEndingResponse:
      'Блин, бро, хорошо что не перешёл по ссылке, а то я так же перешёл и мой аккаунт взломали',
    badEndingResponse:
      'Поздравляю, ты толодец, теперь твой аккаунт так же взломан',
  },
...

  {
    ...
    options: [
      {
        id: 1,
        text: 'Я сам проверю заказ в приложении. По ссылкам не перехожу.',
      },
...

  {
    ...
    badEndingResponse:
      'Попался. Теперь у нас есть все твои пароли и доступ ко всем твоим аккаунтам',
  },
]
