...
export function ChatView({ state, onSelectOption, onBack }: IProps) {
  ...
  return (
    <section
      className={styles.chatViewSection}
      aria-labelledby="chat-view-heading"
    >
      <header className={styles.chatViewHeader}>
        ...
        <div className={styles.chatViewContact}>
          <span className={styles.chatViewEmoji} aria-hidden="true">
            {chat.contactEmoji}
          </span>
          <div>
            <h2 id="chat-view-heading" className={styles.chatViewName}>
              {chat.contactName}
            </h2>
      ...
      <div
        ...
        aria-live="polite"
      >
        <div className={styles.messageDateSep} aria-hidden="true">
          Сегодня
        </div>
        ...
        <div className={styles.messageRow}>
          ...
          <div className={styles.bubbleWrap}>
            <article
              ...
              aria-label={`Сообщение от ${chat.contactName}`}
            >
        ...
        {isAnswered && selectedOption && (
          <div className={clsx(styles.messageRow, styles.messageRowOutgoing)}>
            <div className={styles.bubbleWrap}>
              <article
                className={clsx(styles.bubble, styles.bubbleOutgoing)}
            ...
            <div className={styles.bubbleWrap}>
              ...
              >
                <p className={styles.bubbleText}>
                  {outcome === 'good'
                    ? chat.goodEndingResponse
                    : chat.badEndingResponse}
                </p>
              </article>
              <time className={styles.bubbleTime}>{chat.time}</time>
            </div>
