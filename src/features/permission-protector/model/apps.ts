...
export const APP_SCENARIOS: AppScenario[] = [
  {
    ...
    hints: {
      camera:
        'Навигатору не нужна камера — он строит маршруты, а не делает фото.',
      contacts:
        'Навигатору не нужны контакты — он работает с картами, а не со списком людей.',
      gallery: 'Навигатору не нужна галерея — он не редактирует фотографии.',
      microphone:
        'Навигатору не нужен микрофон — он работает с картами, а не с голосовыми командами.',
    },
  },
  {
    id: 2,
    ...
    hints: {
      contacts:
        'Фоторедактору не нужны контакты — он работает с фото, а не со списком людей.',
      location:
        'Фоторедактору не нужна геолокация — он редактирует снимки, а не строит маршруты.',
      microphone:
        'Фоторедактору не нужен микрофон — он работает с изображениями, а не звуком.',
    },
  },
  {
    id: 3,
    ...
    hints: {
      location:
        'Мессенджеру не нужна геолокация для основной работы — это лишний доступ.',
    },
  },
  {
    id: 4,
    ...
    hints: {
      contacts:
        'Видеочату не нужны контакты — ты присоединяешься по ссылке или коду комнаты.',
      location:
        'Видеочату не нужна геолокация — твоё местоположение для звонков не нужно.',
      gallery:
        'Видеочату не нужна галерея — он предназначен только для видеозвонков.',
    },
  },
  {
    id: 5,
    ...
    hints: {
      ...
      contacts:
        'Контакты не нужны для погоды — оно работает с метеоданными, а не со списком людей.',
      microphone:
        'Микрофон не нужен для погодного виджета — он не принимает голосовые команды.',
      gallery:
        'Галерея не нужна приложению погоды — оно не работает с фотографиями.',
    },
  },
]
