...
export const DOMAIN_ROUNDS: DomainRound[] = [
  {
    id: 1,
    question:
      'Среди этих адресов есть фишинговый. Попробуй его вычислить!',
    phishingExplanation:
    ...
    domains: [
      ...
      { id: 3, value: 'youtube.com', isPhishing: false },
  ...
  },
  {
    id: 2,
    question:
      'Среди этих сайтов есть фишинговый. Попробуй его вычислить!',
    phishingExplanation:
  ...
  },
  {
    id: 5,
    question:
      'Финальный раунд! Среди этих сайтов есть фишинговый. Попробуй его вычислить!',
    phishingExplanation:
